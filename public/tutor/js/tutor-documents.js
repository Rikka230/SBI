/**
 * =======================================================================
 * SBI 8.0P.167.290 — Espace TUTEUR « Documents de formation » (lecture seule)
 * -----------------------------------------------------------------------
...
} from '/js/formation-documents/formation-docs-data.js?v=8.0P.167.290';
import {
  resolvePlanningModel, renderPlanningHtml, downloadPlanningPdf
} from '/js/formation-documents/planning-render.js?v=8.0P.167.290';
import { loadBookletsForTutor } from '/js/booklet/booklet-data.js?v=8.0P.167.290';
