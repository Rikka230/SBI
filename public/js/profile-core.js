 ...
 * 8.0P.167.71.2 : accordéons Suivi pédagogique + filtre archives documents corrigé.
...
import { waitForSbiComponents } from '/js/profile/profile-utils.js?v=8.0P.167.71.2';
import { hydrateLoggedInTopbar } from '/js/profile/profile-topbar.js';
import { renderProfileShell } from '/js/profile/profile-render.js?v=8.0P.167.71.2';
import { renderUserFormations } from '/js/profile/profile-formations.js';
import { renderStudentDocumentsPanel } from '/js/profile/profile-student-documents.js?v=8.0P.167.71.2';
