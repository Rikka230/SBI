...
import { loadFormationDocumentsForFormations } from '/js/formation-documents/formation-docs-data.js?v=8.0P.167.304';
...
export async function loadCursusItems({ db, cursusId = '' } = {}) {
  ...
  // SBI 8.0P.167.304 — La collection curriculumTemplates est en lecture ADMIN
