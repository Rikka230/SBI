...
import { createRouteRegistry } from './route-registry.js?v=8.0P.167.245';
import { createRouter } from './router.js?v=8.0P.167.245';
...
function getPjaxProbeDefinitions() {
  return [
    ...
    { group: 'student', path: '/student/live-replay.html?liveId=test', label: 'Student live replay' },
