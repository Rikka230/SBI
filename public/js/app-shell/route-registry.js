...
async function mountAdminCourses({ url }) {
  ...
  try {
    const module = await import('/admin/js/admin-courses.js?v=8.0P.167.377');
...
async function mountTeacherAssignments({ url }) {
  ...
  try {
    const module = await import('/teacher/js/teacher-assignments.js?v=8.0P.167.362');
...
async function mountStudentAssignments({ url }) {
  ...
  try {
    const module = await import('/student/js/student-assignments.js?v=8.0P.167.362');
...
async function mountAdminBooklets({ url }) {
  ...
  try {
    const module = await import('/admin/js/apprenticeship-booklets.js?v=8.0P.167.375');
...
async function mountStudentBooklet({ url }) {
  ...
  try {
    const module = await import('/student/js/student-livret.js?v=8.0P.167.375');
...
async function mountTeacherBooklets({ url }) {
  ...
  try {
    const module = await import('/teacher/js/teacher-livrets.js?v=8.0P.167.375');
...
async function mountAdminAnalytics({ url }) {
  ...
  try {
    const module = await import('/admin/js/admin-analytics.js?v=8.0P.167.376');
...
async function mountTutorBooklet({ url }) {
  ...
  try {
    const module = await import('/tutor/js/tutor-livret.js?v=8.0P.167.375');
