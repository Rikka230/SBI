...
const HARD_RELOAD_PATHS = new Map([
  ...
  ['/teacher/lives', 'page Lives prof isolée hors PJAX'],
  ['/teacher/lives.html', 'page Lives prof isolée hors PJAX'],
  ['/teacher/lives-v2.html', 'page Lives prof isolée hors PJAX'],
