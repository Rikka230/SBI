...
export const SBI_VERSION = {
  ...
  label: 'SBI 8.0P.167.356 - Bibliothèque : chaîne PJAX rafraîchie (admin-courses .188 → .356 dans route-registry) — blocs repliés aussi en navigation douce'
};
