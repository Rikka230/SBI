...
export const SBI_VERSION = {
  version: '8.0P.167.374',
  branch: 'fix-library-sort-pjax',
  ...
  label: 'SBI 8.0P.167.374 - Gestionnaire de cours : CORRECTIF du tri/filtres (le menu reagissait mais ne triait rien). En PJAX le DOM est recree mais le garde-fou wireLibraryFilters restait a true => nouveaux selects sans ecouteur. resetAdminCoursesStateForMount remet le garde-fou a false (+ libraryView/cache). Vars biblio remontees en tete de module (TDZ, car autoMount tourne a l eval).'
};
