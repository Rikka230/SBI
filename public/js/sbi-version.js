...
export const SBI_VERSION = {
  ...
  label: 'SBI 8.0P.167.360 - Items cursus : titres lus depuis le TEMPLATE du cursus (source de verite, renommages pris en compte) dans le selecteur devoirs et la CF de liaison'
};
