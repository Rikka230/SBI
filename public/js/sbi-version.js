...
export const SBI_VERSION = {
  version: '8.0P.167.362',
  branch: 'feature-assignments-kind-tabs',
  ...
  label: 'SBI 8.0P.167.362 - Devoirs & Evaluations : onglet de type (Tout / Devoirs / Evaluations) cote eleve ET prof pour separer la liste des devoirs et des evaluations (rail sur une ligne, filtre sur assignment.kind)'
};
