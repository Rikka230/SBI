...
export const SBI_VERSION = {
  version: '8.0P.167.344',
  branch: 'feature-messagerie',
  channel: 'Messagerie : correctif overlay « Nouveau message » (l\'attribut [hidden] était écrasé par les display:flex de classe → overlay coincé ouvert + contacts jamais déclenchés). PJAX + anti-spin contacts + badge complétude admin-only.',
  ...
  label: 'SBI 8.0P.167.344 - Messagerie : correctif overlay Nouveau message ([hidden]) + PJAX + anti-spin'
};
