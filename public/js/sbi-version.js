...
export const SBI_VERSION = {
  ...
  label: 'SBI 8.0P.167.363 - Audience : page admin de mesure d audience maison (visiteurs, temps moyen, fiches ouvertes, brochures, contacts) + entree de nav Audience dans le panneau admin'
};
