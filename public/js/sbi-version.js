...
export const SBI_VERSION = {
  version: '8.0P.167.341',
  branch: 'feature-messagerie',
  channel: 'Messagerie interne : 1:1 prof↔élève / élève↔élève (même formation) + salons de formation + annonces admin unidirectionnelles.',
  ...
  label: 'SBI 8.0P.167.341 - Messagerie interne (1:1 + salons formation + annonces admin)'
};
