...
export const SBI_VERSION = {
  ...
  label: 'SBI 8.0P.167.359 - FIX imports sans jeton (bibliothèque KO, formulaire devoirs) + items cursus nommés par leur cours de rattachement (« après “…” ») dans le sélecteur et les badges'
};
