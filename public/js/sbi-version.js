...
export const SBI_VERSION = {
  version: '8.0P.167.371',
  branch: 'fix-viewer-capsule-clearance',
  ...
  label: 'SBI 8.0P.167.371 - Visualiseuse mobile : la fin du chapitre ne passe plus sous la capsule. Le padding-bas reel est dans sbi-7-1-harmonization.css (.viewer-main, !important) qui ecrasait viewer.css : passe de 96px (gap 21px) a 128px (gap ~53px, mesure headless). (.369 = fix TDZ qui figeait les lecons.)'
};
