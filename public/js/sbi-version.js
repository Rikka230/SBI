...
export const SBI_VERSION = {
  version: '8.0P.167.343',
  branch: 'feature-messagerie',
  channel: 'Messagerie : intégration PJAX (routes student/teacher/admin enregistrées) + garde-fou anti-spin sur le chargement des contacts + badge complétude admin-only.',
  ...
  label: 'SBI 8.0P.167.343 - Messagerie : PJAX + anti-spin contacts + badge complétude admin-only'
};
