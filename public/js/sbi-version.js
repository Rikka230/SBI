...
export const SBI_VERSION = {
  ...
  label: 'SBI 8.0P.167.370 - Visualiseuse mobile : padding bas sur .viewer-main (≤1024px) pour que la fin du chapitre ne passe plus sous la capsule flottante. (.369 = fix TDZ qui figeait les lecons : minuteur/actions dans la capsule, barre du bas masquee.)'
};
