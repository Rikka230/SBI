...
export const SBI_VERSION = {
  version: '8.0P.167.358',
  branch: 'feature-assignment-cursus-link',
  ...
  label: 'SBI 8.0P.167.358 - Devoirs liés au cursus (sélecteur item, badge, tri, échéance proposée, devoirs dans la progression élève + retards Plan B) + retrait image/vidéo dans les éditeurs de cours'
};
