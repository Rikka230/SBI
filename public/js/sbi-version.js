...
export const SBI_VERSION = {
  version: '8.0P.167.378',
  branch: 'first-login-gate-mobile',
  ...
  label: 'SBI 8.0P.167.378 - Premiere connexion sur MOBILE : le bouton « Valider et continuer » etait recouvert par la barre de navigation basse (bottom-nav z-index 6000 > panneau 5000) => impossible de valider la premiere connexion depuis un telephone. Fix : le panneau (et la notice etudiante) passent AU-DESSUS de la nav (z 6500/6490), l overlay devient scrollable (flex + margin:auto sur la carte, plus de clip haut/bas quand la carte depasse l ecran) + marge basse safe-area iOS.'
};
