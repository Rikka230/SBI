...
export const SBI_VERSION = {
  version: '8.0P.167.367',
  branch: 'feature-viewer-mobile-nav',
  ...
  label: 'SBI 8.0P.167.367 - Visualiseuse mobile : la barre d action en bas de page disparait (sauf bouton Refaire QCM/trous), tout passe par la capsule flottante. Le slot Suiv. devient le bouton d action principal et affiche le minuteur (decompte) a la place de la fleche tant qu il n est pas fini, puis Valider / Continuer.'
};
