...
import { recomputeBookletPeriodDates } from '/js/booklet/booklet-data.js?v=8.0P.167.296';
...
function fieldHtml({ key, label, value, target, multiline = true, type = 'text', full = false }) {
  // 8.0P.167.296 — CORRECTIF MAJEUR : pour une SECTION, le droit s'évalue sur le
