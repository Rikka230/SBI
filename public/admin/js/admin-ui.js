...
import { initSbiAppShell } from '/js/app-shell/app-shell.js?v=8.0P.167.227';
import { initSbiVersionBadge } from '/js/sbi-version-badge.js?v=8.0P.167.227';

/**
 * SBI 8.0P.167.227 - Internal UI bootstrap
 *
