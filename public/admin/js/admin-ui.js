...
import { initSbiAppShell } from '/js/app-shell/app-shell.js?v=8.0P.167.229';
import { initSbiVersionBadge } from '/js/sbi-version-badge.js?v=8.0P.167.229';

/**
 * SBI 8.0P.167.229 - Internal UI bootstrap
 *
