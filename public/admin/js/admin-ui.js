...
import { initSbiAppShell } from '/js/app-shell/app-shell.js?v=8.0P.167.241';
import { initSbiVersionBadge } from '/js/sbi-version-badge.js?v=8.0P.167.241';

/**
 * SBI 8.0P.167.241 - Internal UI bootstrap
 *
...
async function initInternalUi() {
  try {
    ...
    await callOptionalModule('/admin/js/admin-ui/assistant.js?v=8.0P.167.241', 'initAssistantPrototype');
