...
import { initSbiAppShell } from '/js/app-shell/app-shell.js?v=8.0P.167.226';
import { initSbiVersionBadge } from '/js/sbi-version-badge.js?v=8.0P.167.226';

/**
 * SBI 8.0P.167.226 - Internal UI bootstrap
 *
