    ...
    this.innerHTML = `
      <aside id="left-panel" class="side-panel">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item ${path.includes('/tutor/livret') ? 'active' : ''}" data-sbi-href="/tutor/livret.html" role="link" tabindex="0">${ICON_APPRENTICES}<span class="nav-text">Mes apprentis</span></li>
        </ul>
