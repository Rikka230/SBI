    ...
    this.innerHTML = `
      <aside id="left-panel" class="side-panel">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item ${path.includes('/student/documents.html') ? 'active' : ''}" data-sbi-href="/student/documents.html" role="link" tabindex="0"><svg viewBox="0 0 24 24"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7Zm2 3v8h14v-8H5Z"/></svg><span class="nav-text">Mes documents</span></li>
    ...
    this.innerHTML = `
      <header class="top-bar" style="border-bottom:1px solid var(--border-color); background-color:rgba(255,255,255,.95); backdrop-filter:blur(10px);">
        ...
        <div style="display:flex; align-items:center; gap:1.5rem; margin-left:auto; padding-right:1rem;">
          ...
          <div style="display:flex; align-items:center; gap:1rem; cursor:pointer; border-left:1px solid var(--border-color); padding-left:1.5rem; transition:opacity .2s;" data-sbi-href="/student/mon-profil.html" role="link" tabindex="0">
