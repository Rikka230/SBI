    ...
    this.innerHTML = `
      <aside id="left-panel" class="side-panel">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item ${path.includes('/teacher/lives.html') && !path.includes('/teacher/lives-v2.html') ? 'active' : ''}" data-sbi-href="/teacher/lives.html" role="link" tabindex="0">${ICONS.live}<span class="nav-text">Lives V1</span></li>
          <li class="nav-item ${path.includes('/teacher/lives-v2.html') ? 'active' : ''}" data-sbi-href="/teacher/lives-v2.html" role="link" tabindex="0">${ICONS.live}<span class="nav-text">Lives V2</span></li>
