    ...
    this.innerHTML = `
      <aside id="left-panel" class="side-panel">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item ${path.includes('/teacher/lives') ? 'active' : ''}" data-sbi-href="/teacher/lives.html" data-sbi-no-pjax="true" role="link" tabindex="0">${ICONS.live}<span class="nav-text">Lives</span></li>
