    ...
    this.innerHTML = `
      <aside id="left-panel" class="side-panel">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item ${path.includes('/teacher/lives.html') ? 'active' : ''}" data-sbi-href="/teacher/lives.html" role="link" tabindex="0">${ICONS.live}<span class="nav-text">Lives</span></li>
